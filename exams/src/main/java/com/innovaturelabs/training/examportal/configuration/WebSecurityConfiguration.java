 ...
 */
package com.innovaturelabs.training.examportal.configuration;
...
import com.innovaturelabs.training.examportal.security.AccessTokenProcessingFilter;
import com.innovaturelabs.training.examportal.security.AccessTokenUserDetailsService;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(POST,"/users/resetPassword/**").anonymous()
